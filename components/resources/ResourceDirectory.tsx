...
function ResourceDirectory({ directories }: any) {
  return (
    <section id="directory" className="relative px-10 md:p-3">
      <div className="relative mx-auto mt-8">
        ...
        <div className="text-gray-200 grid grid-cols-1 lg:grid-cols-2 gap-5 items-center mx-auto max-w-[500px] md:max-w-[750px] lg:max-w-[1400px]">
            ...
            return (
              <div key={directory._id} className="overflow-hidden rounded-xl">
                <div className="grid grid-cols-1 mx-auto md:mx-none md:grid-cols-2 group cursor-pointer bg-slate-600/70 min-h-[22.5rem]">
                  ...
                  <div className="z-[2] px-4 md:px-0 md:text-left mt-10 lg:mt-2 md:ml-[-100px] md:mr-4 lg:ml-10 xl:ml-[-20px] xl:mr-0 xl:px-0 pt-8">
