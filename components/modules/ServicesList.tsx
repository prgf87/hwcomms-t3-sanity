        ...
        <div className="grid grid-cols-4 max-w-[80vw] lg:max-w-[85vw] items-center mx-auto">
          ...
          <div className="col-span-2">
            <div className="mx-[18px] px-2 space-y-12 py-5 text-[0.9rem] shadow-xl bg-black/40 rounded-xl">
              ...
              <div className="h-40 grid border-2 rounded-xl border-gray-800/20 p-[0.10rem] px-2 bg-stone-600/70 text-gray-200 hover:text-gray-300 hover:bg-stone-700/80 hover:border-gray-800/20 transition transform ease-in duration-300">
                <h1 className="text-xl sm:text-2xl font-bold my-2">
              ...
              <div className="h-40 grid border-2 rounded-xl border-gray-800/20 p-[0.10rem] px-2 bg-slate-600/70 text-gray-200 hover:text-gray-300 hover:bg-gray-700/80 hover:border-gray-800/20 transition transform ease-in duration-300">
                <h1 className="text-xl sm:text-2xl font-bold my-2">
              ...
              <div className="h-40 grid border-2 rounded-xl border-gray-800/20 p-[0.10rem] px-2 bg-stone-600/70 text-gray-200 hover:text-gray-300 hover:bg-gray-700/80 hover:border-gray-800/20 transition transform ease-in duration-300">
                <h1 className="text-xl sm:text-2xl font-bold my-2">
